 ...
 * parse the response.
 */
public final class Utils_ex {

    /** Tag for the log messages */
    public static final String LOG_TAG = Utils_ex.class.getSimpleName();
        ...
        try {
            ...
            if (featureArray.length() > 0) {
                ...
                for (int i=0; i<featureArray.length(); i++){
                    ...
                    Earthquake quake = new Earthquake(title, numberOfPeople, perceivedStrength, link);
                    temp.add(quake);
                    Log.e("error", perceivedStrength);
                }
